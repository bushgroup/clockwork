...
is a property of this function rather than of the button that calls it. It sits beside
the lower layers rather than inside `clockwork.app` because the owner of the hardware
names a series' replicates one at a time (`clockwork.owner`), and that owner imports
nothing from the window; `clockwork.app.naming` is kept as the same names.
"""
